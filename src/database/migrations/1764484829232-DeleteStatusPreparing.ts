...
export class DeleteStatusPreparing1764484829232 implements MigrationInterface {
  name = 'DeleteStatusPreparing1764484829232';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."order_schedule_status_enum" AS ENUM('pending', 'rejected', 'delivering', 'delivered', 'completed', 'canceled', 'approved')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."harvest_schedule_status_enum" AS ENUM('pending', 'rejected', 'delivering', 'delivered', 'completed', 'canceled', 'approved')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."harvest_schedule_status_enum_old" AS ENUM('pending', 'rejected', 'preparing', 'delivering', 'delivered', 'completed', 'canceled', 'approved')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."order_schedule_status_enum_old" AS ENUM('pending', 'rejected', 'preparing', 'delivering', 'delivered', 'completed', 'canceled', 'approved')`,
    );
    await queryRunner.query(
